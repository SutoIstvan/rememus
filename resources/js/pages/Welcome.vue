<template>
  <div class="bg-white dark:bg-black overflow-x-hidden">
    ...
    <!-- Hero Section -->
    <section
      class="hero-section pt-[180px] md:pt-[200px] lg:pt-[200px] xl:pt-[220px] bg-[url('/images/front/hero-bg.png')] bg-no-repeat bg-cover bg-top relative z-0">
      <!-- Hero Title Content -->
      <div
        ...
        <div class="relative z-0">
          ...
          <div class="flex flex-col lg:flex-row">
            ...
            <div class="lg:flex-1/3 lg:pe-[42px]">
              <div v-scroll-animate="{ direction: 'left', delay: 200 }" class="relative h-full max-lg:mx-auto">
                <figure class="shadow-lg absolute lg:right-0 lg:bottom-0 w-[300px]
                  ...
                  <img :src="person.image" :alt="person.name" class="w-[300px] h-[300px] object-cover rounded-[10px]" />
                </figure>
              </div>
            </div>
      ...
      <div class="lp:!max-w-[1290px] xl:max-w-[1140px] lg:max-w-[960px] mx-auto px-4 md:px-6 lg:px-8">
        <div class="text-center space-y-5 mx-auto">
          ...
          <div class="text-gray-700">
            ...
            <p v-scroll-animate="{ delay: 300 }" class="dropcap text-start text-lg" v-html="memorial.description">
            </p>
          </div>
        </div>
      </div>
