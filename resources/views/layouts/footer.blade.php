  <footer class="footer footer-three bg-white dark:bg-background-8 dark:bg-background-6 relative overflow-hidden">
    <div class="main-container">
      ...
      <figure data-ns-animate data-delay="0.7" data-offset="100" data-direction="right"
        class="footer-gradient-visible absolute overflow-hidden hidden {=$bg-gradient-class}">
              ...
              <a href="#" class="footer-social-link">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    class="stroke-secondary dark:stroke-accent" stroke-width="1.5" stroke-linecap="round"
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    class="stroke-secondary dark:stroke-accent" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <rect x="11" y="5" width="2" height="2" rx="1" transform="rotate(-90 11 5)"
                    class="fill-secondary dark:fill-accent" />
                  <rect x="11.5" y="4.5" width="1" height="1" rx="0.5" transform="rotate(-90 11.5 4.5)"
                    class="stroke-secondary dark:stroke-accent" stroke-linecap="round" />
                </svg>
              </a>
              <div class="h-5 w-px bg-stroke-1 dark:bg-stroke-8"></div>
              <a href="#" class="footer-social-link">
  ...
  <!-- =========================
    Video Modal
    ===========================-->
  <dialog class="modal-overlay fixed top-0 left-0 h-full w-full bg-black/95 !z-[9999]">
    <div
      class="modal-content lg:max-w-[1000px] max-w-[80%] lg:max-h-[600px] sm:max-h-[400px] md:max-h-[450px] max-h-[30%] h-full w-full max-[400px]:rounded-2xl max-[400px]:max-w-[90%] max-[400px]:max-h-[20%] rounded-[20px] top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 fixed">
      <iframe class="w-full h-full max-[400px]:rounded-2xl rounded-[20px]"
      ...
      <button
        class="modal-close-btn absolute -right-8 -top-8 max-[400px]:-right-4 max-[400px]:-top-4 flex items-center justify-center size-8 bg-white dark:bg-background-5 dark:text-white rounded-full cursor-pointer">
